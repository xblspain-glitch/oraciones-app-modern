/* V2 LAB 217 — contadores con iconos reales y conteos correctos */
(function(){
  'use strict';
  if(window.__v2217CountersInstalled) return;
  window.__v2217CountersInstalled = true;
  ...
  window.renderHomeCountersV2217 = render;
