/* V2.252 · Personajes bíblicos cargados desde JSON.
   El diseño y la navegación permanecen en JavaScript; los datos están en biblical-characters-v2255.json. */
...
async function loadBiblicalCharactersV2252(){
  ...
  try{
    const response=await fetch("biblical-characters-v2255.json?v=255",{cache:"no-store"});
    ...
    console.error("Error cargando biblical-characters-v2255.json",error);
