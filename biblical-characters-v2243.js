/* V2.252 · Personajes bíblicos cargados desde JSON.
   El diseño y la navegación permanecen en JavaScript; los datos están en biblical-characters-v2253.json. */
...
async function loadBiblicalCharactersV2252(){
  ...
  try{
    const response=await fetch("biblical-characters-v2253.json?v=253",{cache:"no-store"});
    ...
    console.error("Error cargando biblical-characters-v2253.json",error);
