...
const APP_VERSION_LABEL = "V2.266";
const APP_VERSION_ZIP = "V2_laboratorio_266_ajustes_v3_iconos.zip";
...
if("serviceWorker" in navigator){window.addEventListener("load",()=>{navigator.serviceWorker.register("sw.js?v=v2-266-ajustes-v3-iconos",{updateViaCache:"none"})})}
