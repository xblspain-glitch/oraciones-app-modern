...
if("serviceWorker" in navigator){window.addEventListener("load",()=>{navigator.serviceWorker.register("sw.js?v=v2-239-sabiduria-jpg-real",{updateViaCache:"none"})})}
...
async function shareVerseCard(cardStyle="classic"){
  try{
    const cardBackgroundsV2219={
      classic:"card-sabiduria-v2239.jpg",
