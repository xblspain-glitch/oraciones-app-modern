...
/* V2.279 · El calendario vive ahora en Mi Biblia de Estudio */
...
const APP_VERSION_LABEL = "V2.279";
const APP_VERSION_ZIP = "Oraciones_V2.279_TARJETAS_FE_DIOS_SIN_ICONOS.zip";
