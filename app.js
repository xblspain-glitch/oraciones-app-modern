...
const APP_VERSION_LABEL = "V2.269";
const APP_VERSION_ZIP = "Oraciones_V2.269_LORA_SOLO_TEXTOS_OFFLINE.zip";
...
if("serviceWorker" in navigator){window.addEventListener("load",()=>{navigator.serviceWorker.register("sw.js?v=v2-269-lora-solo-textos-offline",{updateViaCache:"none"})})}
