...
const APP_VERSION_LABEL = "v2.306";
const APP_VERSION_ZIP = "Oraciones_V2.306_TARJETAS_MILAGROS_ACTUALIZADAS.zip";
...
const APP_VERSION_V31249 = "2.306";
...
INSTALLED_APP_FILES_V31249.splice(2,0,"app-loader.js","app-loader-safe-v2302.js","storage-idb.js","storage-idb-safe-v2302.js");
INSTALLED_APP_FILES_V31249.push("card-milagros-1-v2305.png","card-milagros-2-v2305.png","card-milagros-3-v2305.png");
...
(function setupUpdateNoticeV2293(){
  ...
  window.addEventListener('load',async()=>{
    try{
      const reg=await navigator.serviceWorker.register('sw.js?v=2.306',{updateViaCache:'none'});
...
const CARD_CATEGORY_CATALOG_V31282=[
  ...
  {id:'milagros',label:'Milagros',designs:[{style:'milagros-1',src:'card-milagros-1-v2305.png'},{style:'milagros-2',src:'card-milagros-2-v2305.png'},{style:'milagros-3',src:'card-milagros-3-v2305.png'}]},
...
function openCardCategoryV31282(categoryId){
  ...
  grid.innerHTML=category.designs.map((design,index)=>`<button class="card-design-option-v31282" type="button" onclick="chooseCardStyleV2217('${design.style}')"><img src="${design.src}?v=2.306" alt="Diseño ${index+1} de ${cardCategoryEscapeV31282(category.label)}"><span><strong>Diseño ${index+1}</strong><small>${cardCategoryEscapeV31282(category.label)}</small></span></button>`).join('');
}
